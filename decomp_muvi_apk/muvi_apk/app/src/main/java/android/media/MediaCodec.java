...
public final class MediaCodec
{
    ...
    public final native void queueInputBuffer(int i, int j, int k, long l, int i1)
        throws CryptoException;

    public final native void queueSecureInputBuffer(int i, int j, CryptoInfo cryptoinfo, long l, int k)
        throws CryptoException;
