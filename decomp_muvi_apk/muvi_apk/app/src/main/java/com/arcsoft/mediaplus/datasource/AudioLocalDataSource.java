...
//            AbsLocalDataSource, MediaItem, Property, AudioItem

public class AudioLocalDataSource extends AbsLocalDataSource
    implements DataSourceFactory.IProduct
{
    protected static class AudioItemBuilder extends AbsLocalDataSource.AbsItemBuilder
    {
        ...
        {
            Cursor cursor = contentresolver.query(Uri.parse((new StringBuilder()).append(android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI).append("/").append(audioitem._id).append("/genres").toString()), new String[] {
                "name"
            }, null, null, null);
            String s = null;
            if (cursor != null)
        ...
        {
            Cursor cursor = contentresolver.query(Uri.parse((new StringBuilder()).append(android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI).append("/").append(audioitem._id).toString()), new String[] {
                "date_modified"
            }, null, null, null);
            long l = 0L;
...
_L5:
        ...
        protected void onOpen()
        {
            ...
            as1 = getWhereArgs();
            mCursor = mContentResolver.query(AudioLocalDataSource.URI, as, s, as1, getSortOrder());
            if (mCursor == null)
            {
        ...
        public AudioItemBuilder setId(long l)
        {
            mId = Long.valueOf(l);
            return this;
        }

        public AudioItemBuilder setSortOrder(Property property, boolean flag)
        {
    ...
    AudioLocalDataSource(ContentResolver contentresolver)
    {
        super(contentresolver);
        mItemBuilder = new AudioItemBuilder(mContentResolver);
    }
