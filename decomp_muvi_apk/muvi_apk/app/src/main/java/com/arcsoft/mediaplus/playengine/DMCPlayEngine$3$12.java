    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (!DMCPlayEngine.access$1600(_fld0, MsgType.MSG_OPEN, val$renderudn, null))
        {
            return;
        }
        DMCPlayEngineStatusMachine dmcplayenginestatusmachine = DMCPlayEngine.access$400(_fld0);
        Machine.TransformAction transformaction = Machine.TransformAction.OPEN;
        boolean flag;
        if (val$errorcode == 0)
        {
            flag = true;
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        public void onOpenMedia(int i, final String renderudn)
        {
            ...
            DMCPlayEngine.access$300(DMCPlayEngine.this, i. new DMCPlayEngine._cls3._cls12());
        }
