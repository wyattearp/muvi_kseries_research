    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (!DMCPlayEngine.access$1600(_fld0, cMsgType.MSG_PAUSE, val$renderudn, null))
        {
            return;
        }
        DMCPlayEngineStatusMachine dmcplayenginestatusmachine = DMCPlayEngine.access$400(_fld0);
        sMachine.TransformAction transformaction = sMachine.TransformAction.PAUSE;
        boolean flag;
        if (val$errorcode == 0)
        {
            flag = true;
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        public void onMediaPause(int i, final String renderudn)
        {
            ...
            DMCPlayEngine.access$300(DMCPlayEngine.this, i. new DMCPlayEngine._cls3._cls8());
        }
