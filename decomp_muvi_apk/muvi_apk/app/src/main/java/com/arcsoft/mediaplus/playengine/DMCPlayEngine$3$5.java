    ...
    implements Runnable
{
    ...
    final com.arcsoft.adk.atv.nGetPositionInfo val$data;
    final int val$errorcode;
    final String val$renderudn;

    public void run()
    {
        while (!DMCPlayEngine.access$600(_fld0, cMsgType.MSG_GETPOSITION, val$renderudn) || val$errorcode != 0 || !DMCPlayEngine.access$700(_fld0, val$data.m_strTrackUri)) 
        {
            return;
        }
        long l = 1000L * TimeUtils.convertTimeStringToSec(val$data.m_strRelTime);
        long l1 = 1000L * TimeUtils.convertTimeStringToSec(val$data.m_strTrackDuration);
        DMCPlayEngine.access$900(_fld0, l, l1);
    }
    ...
    nfo()
    {
        ...
        val$renderudn = s;
        val$errorcode = i;
        val$data = com.arcsoft.adk.atv.nGetPositionInfo.this;
        super();
    }
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        public void onGetPositionInfo(final int errorcode, com.arcsoft.adk.atv.MRCPCallback.DataOnGetPositionInfo dataongetpositioninfo, final String renderudn)
        {
            ...
            {
                DMCPlayEngine.access$300(DMCPlayEngine.this, dataongetpositioninfo. new DMCPlayEngine._cls3._cls5());
                return;
            }
        }
