...
//            IDlnaSettingCallback, DeviceIcon

public interface IDlnaSettingBinder
    extends IInterface
{
        ...
        implements IDlnaSettingBinder
    {
        ...
        public static IDlnaSettingBinder asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("com.arcsoft.mediaplus.service.util.IDlnaSettingBinder");
...
_L1:
    ...
    public abstract boolean abortUploadAndDownloadTask(boolean flag)
        throws RemoteException;

    public abstract String getActiveDmrUDN()
        throws RemoteException;

    public abstract String getActiveDmsUDN()
        throws RemoteException;

    public abstract String getDmrFriendlyName(String s)
        throws RemoteException;

    public abstract String getDmrManufacture(String s)
        throws RemoteException;

    public abstract String getDmrModelName(String s)
        throws RemoteException;

    public abstract List getDmrUDNicon(String s)
        throws RemoteException;

    public abstract String getDmsFriendlyName(String s)
        throws RemoteException;

    public abstract String getDmsManufacture(String s)
        throws RemoteException;

    public abstract String getDmsModelName(String s)
        throws RemoteException;

    public abstract List getDmsUDNicon(String s)
        throws RemoteException;

    public abstract boolean getOnlineContentsListviewMode()
        throws RemoteException;

    public abstract String[] getOnlineDmrUDN()
        throws RemoteException;

    public abstract String[] getOnlineDmsUDN()
        throws RemoteException;

    public abstract boolean getTelevisionStreamingResolution()
        throws RemoteException;

    public abstract int getUploadAndDownloadTaskCount()
        throws RemoteException;

    public abstract boolean isDmrOnline(String s)
        throws RemoteException;

    public abstract boolean isDmsOnline(String s)
        throws RemoteException;

    public abstract boolean isResAdapttoActiveDMR(String s)
        throws RemoteException;

    public abstract boolean isResAdapttoDMR(String s, String s1)
        throws RemoteException;

    public abstract void registerCallback(IDlnaSettingCallback idlnasettingcallback)
        throws RemoteException;

    public abstract boolean resumeUploadAndDownloadTask()
        throws RemoteException;

    public abstract boolean setActiveDmr(String s)
        throws RemoteException;

    public abstract boolean setActiveDms(String s)
        throws RemoteException;

    public abstract boolean setOnlineContentsListviewMode(boolean flag)
        throws RemoteException;

    public abstract boolean setTelevisionStreamingResolution(boolean flag)
        throws RemoteException;

    public abstract void unregisterCallback(IDlnaSettingCallback idlnasettingcallback)
        throws RemoteException;
}
