    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (DMCPlayEngine.access$600(_fld0, cMsgType.MSG_GETVOLUME, val$renderudn) && val$errorcode == 0 && DMCPlayEngine.access$1100(_fld0) != val$volume)
        {
            DMCPlayEngine.access$1102(_fld0, val$volume);
            if (DMCPlayEngine.access$500(_fld0) != null)
            {
                DMCPlayEngine.access$500(_fld0).OnVolumeChanged(val$volume);
                return;
            }
        }
    }
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        {
            DMCPlayEngine.access$300(DMCPlayEngine.this, i. new DMCPlayEngine._cls3._cls4());
        }
