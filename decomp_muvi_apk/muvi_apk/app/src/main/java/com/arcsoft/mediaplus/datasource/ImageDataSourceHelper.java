...
public final class ImageDataSourceHelper
{
    ...
    public static Boolean getMimeType(int i, IDataSource idatasource)
    {
        Boolean boolean1 = Boolean.valueOf(true);
        if (idatasource != null)
        {
            boolean1 = Boolean.valueOf(idatasource.getBooleanProp(i, Property.PROP_VIDEO_OR_IMAGE, boolean1.booleanValue()));
        }
        return boolean1;
    }
