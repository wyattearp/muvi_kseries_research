    ...
    implements Runnable
{
    ...
    final com.arcsoft.adk.atv.nGetMediaInfo val$info;
    final String val$renderudn;

    public void run()
    {
        while (!DMCPlayEngine.access$600(_fld0, cMsgType.MSG_GETMETADATA, val$renderudn) || val$errorcode != 0 || !DMCPlayEngine.access$700(_fld0, val$info.m_strCurUri)) 
        {
            return;
        }
        DMCPlayEngine.access$900(_fld0, DMCPlayEngine.access$800(_fld0).position, 1000L * TimeUtils.convertTimeStringToSec(val$info.m_strMediaDuration));
    }
    ...
    ()
    {
        ...
        val$renderudn = s;
        val$errorcode = i;
        val$info = com.arcsoft.adk.atv.nGetMediaInfo.this;
        super();
    }
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        public void onGetMeidaInfo(final int errorcode, com.arcsoft.adk.atv.MRCPCallback.DataOnGetMediaInfo dataongetmediainfo, final String renderudn)
        {
            ...
            {
                DMCPlayEngine.access$300(DMCPlayEngine.this, dataongetmediainfo. new DMCPlayEngine._cls3._cls2());
                return;
            }
        }
