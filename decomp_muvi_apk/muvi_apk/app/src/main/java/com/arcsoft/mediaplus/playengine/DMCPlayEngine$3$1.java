...
class val.allowedactions
    implements Runnable
{

    final val.allowedactions this$1;
    ...
    public void run()
    {
        if (!DMCPlayEngine.access$600(_fld0, cMsgType.MSG_GETALLOWACTIONS, val$renderudn) || val$errorcode != 0)
        {
            return;
        } else
        {
            Log.w("DMCPlay", (new StringBuilder()).append(" Allowed actions: ").append(val$allowedactions).toString());
            return;
        }
    }
    ...
    topRetryCnt()
    {
        ...
        val$renderudn = s;
        val$errorcode = i;
        val$allowedactions = String.this;
        super();
    }
...
/* anonymous class */
        ...
        implements com.arcsoft.adk.atv.RenderManager.IRenderPlayListener
    {
        ...
        public void onGetCurrentTransportActions(final int errorcode, String s, final String renderudn)
        {
            ...
            {
                DMCPlayEngine.access$300(DMCPlayEngine.this, s. new DMCPlayEngine._cls3._cls1());
                return;
            }
        }
